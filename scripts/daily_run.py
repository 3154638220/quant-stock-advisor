...
def main_run(args: argparse.Namespace) -> int:
    ...
    bundle = compute_base_factor_bundle(
        ...
        low=low_t,
        open_px=open_t,
        trade_dates=wide.columns.tolist(),
        vol_window=vol_w,
    ...
    out = pd.DataFrame(
        {
            ...
            "weekly_kdj_k": _last1("weekly_kdj_k"),
            "weekly_kdj_d": _last1("weekly_kdj_d"),
            "weekly_kdj_j": _last1("weekly_kdj_j"),
            "weekly_kdj_oversold": _last1("weekly_kdj_oversold"),
            "weekly_kdj_oversold_depth": _last1("weekly_kdj_oversold_depth"),
            "weekly_kdj_rebound": _last1("weekly_kdj_rebound"),
            # K 线结构高频降频代理因子
    ...
    _FACTORS_TO_NEUTRALIZE = [
        ...
        "price_position", "weekly_kdj_k", "weekly_kdj_d", "weekly_kdj_j",
        "weekly_kdj_oversold", "weekly_kdj_oversold_depth", "weekly_kdj_rebound",
        "intraday_range", "upper_shadow_ratio",
