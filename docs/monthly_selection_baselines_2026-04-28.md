...
- 生成时间：`2026-04-28T14:31:39.081202+00:00`
...
- 输出 stem：`monthly_selection_baselines_2026-04-28`
...
- `U1_liquid_tradable` Top20 领先模型：

| model | model_type | topk_excess_mean | rank_ic_mean | topk_hit_rate | topk_minus_nextk_mean | topk_excess_after_cost_mean |
| --- | --- | --- | --- | --- | --- | --- |
| `M4_xgboost_top20` | `xgboost_classifier` | `0.009633` | `-0.044655` | `0.526316` | `-0.001151` | `0.009678` |
| `M4_elasticnet_excess` | `elasticnet` | `0.009347` | `0.106543` | `0.500000` | `0.001288` | `0.008079` |
| `M4_extratrees_excess` | `tree_sanity` | `0.007915` | `0.112303` | `0.710526` | `0.001694` | `0.006902` |

- `U2_risk_sane` Top20 领先模型：

| model | model_type | topk_excess_mean | rank_ic_mean | topk_hit_rate | topk_minus_nextk_mean | topk_excess_after_cost_mean |
| --- | --- | --- | --- | --- | --- | --- |
| `M4_elasticnet_excess` | `elasticnet` | `0.009566` | `0.090133` | `0.500000` | `0.012309` | `0.008243` |
| `M4_extratrees_excess` | `tree_sanity` | `0.006313` | `0.094869` | `0.552632` | `0.001805` | `0.004945` |
| `M4_xgboost_top20` | `xgboost_classifier` | `0.002665` | `-0.041751` | `0.500000` | `0.008857` | `0.003227` |
