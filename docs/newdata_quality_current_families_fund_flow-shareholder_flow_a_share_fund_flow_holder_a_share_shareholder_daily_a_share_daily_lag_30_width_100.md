...
- 生成时间：`2026-04-29T17:48:39.051181+00:00`
...
- `fund_flow`：资金流最新 `2026-04-29`，日线最新 `2026-04-29`；未匹配 `64931` 行，其中 `0` 行晚于日线最新日期，`64931` 行位于日线覆盖区间内。覆盖区间内未匹配里，`64931` 行来自日线表完全没有的 `556` 个标的，`0` 行是日线已覆盖标的但具体日期未匹配。
